...
function enlargeImg(img, orientation) {
  ...
  if(orientation==='h'){
    ...
    enlarged_img.style.height="282px";
    ...
    enlarged_img.style.width="232px";
    enlarged_img.style.height="350px";
...
function changeImg(next){
  ...
  }else{ //If the picture is not null, get its orientation from its onclick attribute
